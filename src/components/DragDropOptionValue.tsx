  ...
  return (
    <>
      ...
      {showDragPreview && isDragging && (
        ...
        >
          <div className="p-6 bg-gray-700 rounded-xl space-y-6 border border-blue-400 shadow-2xl shadow-blue-400/30 opacity-90 scale-105 rotate-1 relative cursor-move">
            <ValueContent />
          </div>
        </div>
      )}
