...
const DisplaySettings: React.FC<DisplaySettingsProps> = ({
  ...
  return (
    <>
      {/* Live Preview - Now rendered to body */}
      <div className="fixed top-4 right-4 z-[200] bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-600 shadow-lg max-w-md">
