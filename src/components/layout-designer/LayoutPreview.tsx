...
const LayoutPreview: React.FC<LayoutPreviewProps> = ({ layout, viewport }) => {
  ...
  const renderComponent = (component: any) => {
    ...
    switch (component.type) {
      case 'viewport':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-blue-300 bg-blue-50/50">
      ...
      case 'options':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-green-300 bg-green-50/50">
      ...
      case 'info':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-purple-300 bg-purple-50/50">
      ...
      case 'price':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-yellow-300 bg-yellow-50/50">
      ...
      case 'cart':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-orange-300 bg-orange-50/50">
      ...
      case 'container':
        return (
          <div key={component.id} style={style} className="border-2 border-dashed border-gray-300 bg-gray-50/50">
